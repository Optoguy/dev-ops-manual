...
Portable, dependency-free (stdlib only). Drop it at `src/portability_check.py`.

Usage:
    python src/portability_check.py                 # scan and report
    python src/portability_check.py --strict        # nonzero if anything is unjustified
    python src/portability_check.py --json
